      ...
      <div className="flex lg:flex-row flex-col justify-center items-center bg-white lg:p-5 p-3 lg:w-4/5 w-full">
        ...
        <div className="flex flex-1 flex-col gap-6 lg:pl-5 mt-5 w-full">
          <input
            ...
            className="outline-none text-2xl sm:text-3xl font-bold border-gray-200 p-2 border-b-2"
          />
          {user && (
          ...
          <input
            ...
            className="outline-none text-base sm:text-lg border-gray-200 p-2 border-b-2"
          />
          <input
            type="text"
            value={destination}
            onChange={(e) => setDestination(e.target.value)}
            placeholder="What's destination link"
            className="outline-none text-base sm:text-lg border-gray-200 p-2 border-b-2"
          />
